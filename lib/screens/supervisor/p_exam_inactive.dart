...
class PExamInactive extends StatefulWidget {
  const PExamInactive({super.key});

  @override
  State<PExamInactive> createState() => _PExamInactiveState();
}

class _PExamInactiveState extends State<PExamInactive> {
  final Api _api = Api();
  ...
  ListView _buildListView(context, List<Exam>? exam) {
    return ListView.builder(
      ...
      itemBuilder: (ctx, index) {
        ...
        return PExamCard(exam: data, type: "inactive");
      },
    );
  }
}