...
class PExamFinished extends StatefulWidget {
  const PExamFinished({super.key});

  @override
  State<PExamFinished> createState() => _PExamFinishedState();
}

class _PExamFinishedState extends State<PExamFinished> {
  final Api _api = Api();
  ...
  ListView _buildListView(context, List<Exam>? exam) {
    return ListView.builder(
      ...
      itemBuilder: (ctx, index) {
        ...
        return PExamCard(exam: data, type: "finished");
      },
    );
  }
}